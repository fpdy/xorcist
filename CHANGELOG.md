...
- Hardened TUI edge cases around event handling and view state.
- Improved jj parsing robustness for graph log and show/detail output.

### Changed

- Split UI rendering into focused modules for log, detail, diff, and overlays.
